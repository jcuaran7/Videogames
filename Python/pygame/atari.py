...
soundbrick = pygame.mixer.Sound("sonidos/romper.wav")
gamever=pygame.mixer.Sound("sonidos/game_over.wav")
choque=pygame.mixer.Sound("sonidos/rebote.wav")
esquina=pygame.mixer.Sound("sonidos/esqui.wav")
...
BG_COLOR = (14, 43, 84) # (Red, Green, Blue)
...
fondom = pygame.mixer.music.load("sonidos/fondo.wav")
